...
def subjectchoose():
    ...
    attf = tk.Button(windo,  text="Check Sheets",command=Attf,fg="black"  ,bg="Pink"  ,width=12  ,height=1 ,activebackground = "Black" ,font=('times', 14, ' bold '))
    attf.place(x=430, y=255)

    sub = tk.Label(windo, text="Enter Subject", width=15, height=2, fg="white", bg="Black", font=('times', 15, ' bold '))
    sub.place(x=30, y=100)
